    ...
    <div>
        ...
        <div class="white-box padding-align-20 m-top-40">
            ...
            <el-table :data="tableData" class="normal-table">
                <el-table-column prop="corporationName" label="甲方（公司名称）" width="300"/>
                <el-table-column prop="name" label="乙方（工人姓名）" width="180"/>
                <el-table-column prop="cardNumber" label="身份证号" width="300"/>
                <el-table-column prop="phone" label="手机号" width="180"/>
                <el-table-column prop="updateReason" label="修改原因" width="300"/>
                <el-table-column label="操作" fixed="right" width="180">
                    <template slot-scope="scope">
                        <p class="table-handle">
                            <span @click="changeContract(scope.row)">修改合同</span>
                            <span @click="$router.push(`/contract-management/contract-detail/${scope.row.contractId}?type=3&workerId=${scope.row.workerId}`)">查看详情</span>
                        </p>
                    </template>
                </el-table-column>
            </el-table>
