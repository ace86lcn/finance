                ...
                <el-table-column label="操作" fixed="right" width="120">
                    <template slot-scope="scope">
                        <p class="table-handle">
                            <span @click="$router.push(`/social-management/worker-detail/${scope.row.socialSecurityId}?cardNumber=${scope.row.cardNumber}`)">查看缴纳记录</span>
                        </p>
                    </template>
                </el-table-column>
            </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            getList(val) {
                ...
                this.$http(this.$api.social.SocialPeopleList, {
                    projectId:       this.$store.state.projectId,
                    // projectId:       77,
